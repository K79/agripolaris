...
function navigate_register() {
    window.location.href = "./register.html"; // 遷移先のURLを指定
    //window.location.href = "https://www.google.co.jp/"; // 遷移先のURLを指定
}
function navigate_done() {
    window.location.href = "./done.html"; // 遷移先のURLを指定
    //window.location.href = "https://www.google.co.jp/"; // 遷移先のURLを指定
}
function navigate_confirm() {
    window.location.href = "./confirm.html"; // 遷移先のURLを指定
}
